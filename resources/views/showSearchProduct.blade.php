...
<head>
    ...
    <title>Available Search Product</title>
</head>
<style>
    .header{
        display:block;
...
<body>
    ...
    <div class="container" style='background-color:gray'>
        ...
        @if(isset($searchItems))
          @foreach($searchItems as $displayItems)
            <div class="col-sm-4" id="display-items">
              <img src="/storage/imageFile/{{$displayItems->productImage}}" alt="Product Image">
                <div class="row">
                  <div class="col-sm-6">
                  ...
                  <div class="col-sm-6">
                  <form action="{{route('addToCart',['id'=>$displayItems->id])}}" method="GET">
